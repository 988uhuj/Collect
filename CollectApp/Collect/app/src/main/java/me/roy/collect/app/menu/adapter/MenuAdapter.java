package me.roy.collect.app.menu.adapter;
 ...
 * Description : TODO
 */
public class MenuAdapter extends BaseListAdapter<Map<String, Object>> {
    ...
    public boolean isEnabled(int position) {
        return ModelAndViewFactory.getInstance().isEnable(position);
    }
}
