package me.roy.common.multiplefragment;
...
public class ModelFactory {
    ...
    public ModelFactory addCommonFragment(Class<?> c, List<? extends Serializable> list, List<CharSequence> titleList){
    ...
    public ModelFactory addCommonFragment(List<? extends Fragment> list, List<CharSequence> titleList){
        this.titleList.addAll(titleList);
